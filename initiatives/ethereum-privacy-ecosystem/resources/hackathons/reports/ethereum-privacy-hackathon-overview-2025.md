...
```mermaid
pie title Hackathons by Organizer (40 Total)
    "ETHGlobal (11)" : 27.5
    "Independent (25)" : 62.5
    "ETHWarsaw Foundation (2)" : 5
    "ETHKyiv (2)" : 5
```
...
```mermaid
graph LR
    A["ETHGlobal: 27.5% Events"] -->|"But 75.9% of Submissions"| B["Economies of Scale"]
    C["Independent: 62.5% Events"] -->|"Higher Privacy Intensity"| D["14.7% vs 5.5%"]
    E["ETHWarsaw: 5% Events"] -->|"Exceptional Privacy Focus"| F["32% Privacy Ratio"]
    style B fill:#e1f5e1
    style D fill:#e1f5e1
    style F fill:#e1f5e1
```
...
```mermaid
xychart-beta
    title "Privacy Intensity by ETHGlobal Event Format"
    x-axis ["Virtual", "IRL"]
    y-axis "Privacy %" 0 --> 15
    bar [4.3, 9.0]
```
...
```mermaid
xychart-beta
    title "Privacy Intensity by Prize Bracket (Non-Linear Relationship)"
    x-axis ["<$10K", "$10–50K", "$50–200K", "$200–500K", "$500K+"]
    y-axis "Privacy %" 0 --> 16
    bar [0.8, 9.3, 14.1, 10.5, 8.6]
```
...
```mermaid
pie title Privacy Projects by Category (417 Total)
    "Finance (153)" : 36.7
    "Social & Messaging (100)" : 23.9
    "AI & Data Privacy (51)" : 12.2
    "Auth & Identity (26)" : 6.2
    "Infrastructure (14)" : 3.4
    "Healthcare (12)" : 2.9
    "DAO/Governance (10)" : 2.4
    "Education (2)" : 0.5
    "Other (39)" : 9.3
```
...
```mermaid
pie title ZK Framework Adoption (145 Projects, 34.8% of Privacy)
    "Circom + snarkjs (28)" : 19.3
    "Noir / Aztec (21)" : 14.5
    "Polygon zkEVM (15)" : 10.3
    "Cairo / StarkNet (8)" : 5.5
    "Halo2 / Plonky2 (6)" : 4.1
    "Other/Custom (67)" : 46.2
```
...
```mermaid
graph LR
    A["Pre-Production<br/>Hackathon Demos"] -->|"Circom + snarkjs<br/>(easy onboarding)"| B["28 Projects"]
    C["Growth Stage<br/>with Funding"] -->|"Noir / Aztec<br/>(native contracts)"| D["21 Projects"]
    E["Early Infrastructure<br/>Deployments"] -->|"Polygon zkEVM<br/>(EVM-compatible)"| F["15 Projects"]
    style B fill:#e1f5e1
    style D fill:#e1f5e1
    style F fill:#e1f5e1
```
...
```mermaid
xychart-beta
    title "Adoption of Alternative Privacy Technologies"
    x-axis ["ZK (145)", "MPC (32)", "TEE (18)", "FHE (12)"]
    y-axis "Projects" 0 --> 160
    bar [145, 32, 18, 12]
```
...
```mermaid
xychart-beta
    title "Privacy Project Submissions by Quarter"
    x-axis ["Q1 2025", "Q2 2025", "Q3 2025", "Q4 2025"]
    y-axis "Privacy Projects" 0 --> 200
    bar [22, 114, 177, 104]
```
...
```mermaid
pie title Hackathons by Continent
    "Europe (21)" : 52.5
    "Latin America (5)" : 12.5
    "Asia (5)" : 12.5
    "Africa (3)" : 7.5
    "North America (2)" : 5.0
    "Virtual (4)" : 10.0
...
```mermaid
xychart-beta
    title "Privacy Projects by Continent"
    x-axis ["Europe", "Latin America", "Asia", "Africa", "N. America", "Virtual"]
    y-axis "Privacy Projects" 0 --> 300
    bar [145, 88, 79, 5, 20, 80]
```
...
```mermaid
graph TD
    A["Europe"] -->|"Established Hub"| B["17 Events, 145 Projects"]
    C["Latin America"] -->|"Emerging Star"| D["8 Events, 88 Projects, 12.3%"]
    E["North America"] -->|"Sleeping Giant"| F["2 Events, 20 Projects, 3.9%"]
    G["Asia"] -->|"Mixed Development"| H["5 Events, 79 Projects"]
    I["Africa"] -->|"Early-Stage"| J["2 Events, 5 Projects"]
    style B fill:#e1f5e1
    style D fill:#fff3cd
    style F fill:#ffe1e1
```
...
```mermaid
xychart-beta
    title "Privacy Intensity: IRL vs. Virtual Events"
    x-axis ["IRL Events", "Virtual Events"]
    y-axis "Privacy %" 0 --> 12
    bar [10.04, 4.47]
```
